...
public class RegistrationCode {
    ...
    private String name, username, email, pass, role;
    private char password[], conpassword[];
    private boolean error1, error2, error3, error4, error5, error6, nointernet;
    private int userid;
    private Person user;

    public RegistrationCode(JTextField name, JTextField username, JTextField email, JPasswordField password, JPasswordField conpassword, JComboBox role) {
    ...
    public Person checkAll(JTextField namefld, JTextField usernamefld, JTextField emailfld, JPasswordField passwordfld, JPasswordField confirmpassfld, JLabel nameerr, JLabel unameerr, JLabel emailerr, JLabel passerr, JLabel conpasserr) {
        nointernet = false;
    ...
    private String getRole(JComboBox role) {
        ...
        if (nointernet == false) {
            if (error1 == true && error2 == true && error3 == true && error4 == true && error5 == true && error6 == true) {
                if (role.equalsIgnoreCase("Tester")) {
                    user = new Tester(userid, name, username, email, pass, role);
                } else {
                    user = new Developer(userid, name, username, email, pass, role);
                }
    ...
    public static boolean insert(Person user) {
